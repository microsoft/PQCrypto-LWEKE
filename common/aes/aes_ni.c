...
static inline void aes128_enc(const uint8_t *plaintext, const uint8_t *_schedule, uint8_t *ciphertext) {
	__m128i *schedule = (__m128i *) _schedule;
...
static inline void aes256_enc(const uint8_t *plaintext, const uint8_t *_schedule, uint8_t *ciphertext) {
	__m128i *schedule = (__m128i *) _schedule;
	__m128i m = _mm_loadu_si128((__m128i *) plaintext);
