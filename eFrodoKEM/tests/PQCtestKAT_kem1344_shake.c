/********************************************************************************************
* Abstract: run tests against known answer test vectors for eFrodoKEM-1344 using SHAKE128
*
...
char    AlgName[] = "eFrodoKEM-1344-SHAKE";
...
main()
{
    ...
    do {
        ...
        if ( (ret_val = crypto_kem_keypair_enc_eFrodo1344(ct, ss, pk, sk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_dec_eFrodo1344(ss1, ct, sk)) != 0) {
