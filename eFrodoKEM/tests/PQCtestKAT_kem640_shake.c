/********************************************************************************************
* Abstract: run tests against known answer test vectors for eFrodoKEM-640 using SHAKE128
*
...
char    AlgName[] = "eFrodoKEM-640-SHAKE";
...
main()
{
    ...
    do {
        ...
        if ( (ret_val = crypto_kem_keypair_enc_eFrodo640(ct, ss, pk, sk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_dec_eFrodo640(ss1, ct, sk)) != 0) {
