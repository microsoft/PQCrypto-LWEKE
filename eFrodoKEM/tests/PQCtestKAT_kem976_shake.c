/********************************************************************************************
* Abstract: run tests against known answer test vectors for eFrodoKEM-976 using SHAKE128
*
...
char    AlgName[] = "eFrodoKEM-976-SHAKE";
...
main()
{
    ...
    do {
        ...
        if ( (ret_val = crypto_kem_keypair_enc_eFrodo976(ct, ss, pk, sk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_dec_eFrodo976(ss1, ct, sk)) != 0) {
